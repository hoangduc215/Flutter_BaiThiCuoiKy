  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: buildHomeBody(
        ...
        state: state,
        brands: brands,
        onBranOrKeywordSelected: widget.onBranOrKeywordSelected,
      ),
...
PreferredSizeWidget buildHomeAppBar({
  ...
  required void Function() onSearchChanged,
  required void Function(String value) onSearchSubmit,
}) {
...
Widget buildHomeBody({
  ...
  required void Function(String? brand, String? keyword, String? loai)
  onBranOrKeywordSelected,
}) {
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          onBranOrKeywordSelected(null, null, "DienThoai");
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: const [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          onBranOrKeywordSelected(null, null, "PhuKien");
                        },
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: const [
